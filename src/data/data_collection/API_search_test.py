...
# Google_business_search.get_google_places_by_location(location_name='Ozone Park', business_type='restaurant', search_term='halal')
# Google_business_search.get_corrdinates_from_name('ozone park')
